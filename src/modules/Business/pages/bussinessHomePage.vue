  ...
  <div>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-12 text-start add_project ">
          <button @click="go_add_project" class="btn btn-success p-4 rounded-5 fs-4 border-none">اضف مشروعك</button>
        </div>
      </div>
      ...
      <div v-for="project in paginatedProjects" :key="project.id" @click="setproject(project)" class="card-link"
...
export default {
  setup() {
    ...
    const setproject = (project) => {
      ...
      localStorage.setItem('stages', project.contract ? JSON.stringify(project.contract.stages) : '');
      router.push({
