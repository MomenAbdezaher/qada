        ...
        <div class="container-fluid ">
          ...
          <div class="text-end d-flex responsive-header" v-if="x.matches" style="direction:rtl;flex-wrap: wrap;">
            ...
            <div class="dropdown" :class="!auth ? 'd-none' : ''">
              <button @click="notifications.hideProjects()" class="bg-transparent border-0" type="button"
                id="dropdownMenuButton" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <li class="nav-item res-li mx-lg-5 ms-5 position-relative mt-2 pl-5">
                  <i class="fa-regular fa-bell"></i>
                  <span v-if="notifications.notificationsLength > 0"
              ...
              <div
                style="width: 310px; height:360px;overflow-y:auto ;transition: ; background-color: #248a23;padding-right: 10px;"
                ...
                <!--rejected projects-->
                <div class="rejected-projects d-flex mt-1" v-for="project in notifications.rejected" :key="project"
                  @click="refuseReasone(project)" type="button" data-toggle="modal" data-target="#exampleModal">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-lg-baseline ">
              <li class="nav-item mx-lg-2">
                <router-link class="nav-link qada" to="/member">ميداني<span></span></router-link>
              </li>
              <li class="nav-item mx-lg-2">
              ...
              <div class="dropdown" v-if="!x.matches" :class="!auth ? 'd-none' : ''">
                ...
                <div style="width: 310px; height:360px;overflow-y:auto ; background-color: #248a23;padding-right: 10px;"
                  class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  <div v-for="project in notifications.accepted" :key="project" class="accepted d-flex mt-1">
                    <div class="svg ms-2" v-if="notifications.accepted.length > 0">
                      <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
