<template>
  <div class="conatiner">
    <div v-if="chatApi.conversations.length == 0" class="text-center"><span class="fs-1 text-info fw-bold">لايوجد محادثات</span></div>
    <div class="row main-chat  mx-auto d-flex my-5" v-if="chatApi.conversations.length > 0" v-motion-pop style="transition: 1s;">
      ...
      <div class="col-4">
        ...
        <div class="conv-menu" style="max-height: 40vh;overflow: scroll;">
