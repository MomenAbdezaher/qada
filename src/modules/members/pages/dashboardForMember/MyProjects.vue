  ...
  <div>
    ...
    <div class="d-flex align-items-start">
      <div class="container pt-5 mt-5">
        ...
        <div v-for="project in paginatedProjects " :key="project.id" class="w-100 card-link" v-motion-slide-right
...
const totalPage = computed(() => Math.ceil(projects.allProjects.length / projectsPerPage));

const paginatedProjects = computed(() => {
  const startIndex = (currentPage.value - 1) * projectsPerPage;
  const endIndex = startIndex + projectsPerPage;
  // console.log(projects.allProjects,"value");
  return projects.allProjects.slice(startIndex, endIndex);
});
...
onMounted(() => {
  projects.getprojects('https://test.m-aboelela.online/api/user/projects/index');
});
</script>
<style scoped>
* {
