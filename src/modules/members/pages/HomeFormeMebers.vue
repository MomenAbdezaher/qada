    ...
    <div class="home-member">
      <div class="container w-100 mt-5">
        <div class="row" v-if="auth == ''">
          <div class="header mt-5">
            <div v-if="getData.data.length >= 0" v-motion-slide-left style="transition: 0.5s;">جميع مشاريعك الهندسية تحت
            </div>
            <div class="mensa mt-3" v-motion-slide-left style="transition: 0.5s;">منصة واحدة</div>
            <div class="col-lg-4 m-auto mt-5 text-center" v-motion-slide-right style="transition: 0.5s;">
              <p>
        ...
        <div style="transition: 1.5s;transition-delay:0.5s ;" class="row-col-6 my-5 add-project" v-motion-slide-bottom>
          <button @click="go_add_project" class="btn add-project-text">اطرح مشروعك الآن</button>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="row align-items-baseline">
          <div class="col test test_setp_1">
          ...
          <div class="col test test_setp_2">
        ...
        <div class="row">
          <div class="col-md-12 text-end subtitle_text">
            <span class="text-center d-inline-block">اخر المشاريع المضافة</span>
          </div>

        </div>

        <!-- comment part search -->
        <div v-motion-slide-left style="transition: 0.5s;"
          class="row m-auto justify-content-start p-3 w-50 filter-projects my-5">

          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
            <p>المدينة</p>
            <div class="input-group mb-3">
              <input type="text" class="form-control" placeholder="الرياض" disabled
                aria-label="Amount (to the nearest dollar)">
            </div>
          </div>
          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
            <p>التصنيف</p>
            <select v-model="filter.type" @change="filter.filterType(filteredProjects)" class="form-select"
      ...
      -->
        ...
        <div class="loading w-100 mt-5 pt-5" v-if="filter.lastFilterd.length == 0">
          <div class="text-center w-100"><span class="fs-5 d-inline-block">جارى التحميل...</span></div>
        ...
        <div v-for="project in paginatedProjects " :key="project.id" class="w-100 card-link" @click="setproject(project)"
          v-motion-slide-right style="transition: 0.5s;">
        ...
        <nav>
          <ul class="pagination d-flex justify-content-center ">
            ...
            <li class="page-item" :class="{ disabled: currentPage === totalPage }">
              <button @click="nextPage" :disabled="currentPage === totalPage">التالي</button>
            </li>
          </ul>
        </nav>
...
export default {
  ...
  setup() {
    ...
    const totalPage = computed(() => Math.ceil(allProjects.value.length / projectsPerPage));
