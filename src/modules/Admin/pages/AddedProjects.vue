  ...
  <div class="row added-projects">
    <div class="tab-parent d-flex">
      <div
        class="me-5 tab"
        :style="{
          textDecoration: showComponent == 'last_projects' ? 'underline' : '',
          color: showComponent == 'last_projects' ? 'orangered' : '',
        }"
        @click="showComponent = 'last_projects'"
      >
      ...
      <div class="me-5 tab">
        <span
          class="fs-4"
          @click="showComponent = 'project_requests'"
          :style="{
            textDecoration:
              showComponent == 'project_requests' ? 'underline' : '',
            color: showComponent == 'project_requests' ? 'orangered' : '',
          }"
          >طلبات المشاريع</span
        >
      </div>
    ...
    <div class="col-lg-12">
      <div class="loading w-100 mt-5 pt-5" v-if="allProjects.length == 0">
        <div class="text-center w-100">
          <span class="fs-3 d-inline-block" style="color: white"
            >جارى التحميل...</span
          >
        </div>
      ...
      <div
        ...
        :key="project.id"
        class="w-100 card-link pb-5"
        v-motion-slide-right
        style="transition: 0.5s"
      >
        <div
          class="row justify-content-center my-3 text-decoration-none"
          v-if="showComponent == 'last_projects'"
        >
          <div class="col-lg-11 col-md-12 col-sm-12">
            <div class="card rounded-5">
              <div class="row align-items-baseline justify-content-between">
                ...
                <div
                  class="col-4 d-flex justify-content-end px-5"
                  v-if="getData.data >= 0"
                ></div>
              </div>
              ...
              <div class="row my-3">
                ...
                >
                  ...
                  <div class="card-content">
                    ...
                    <span class="card-content-text mb-1 mt-2"
                      >الرقم المرجعي</span
                    >
                  </div>
                  <div>
                ...
                >
                  ...
                  <div>
                    ...
                    <span v-if="project.offers.length > 0">
                      <span v-for="myF in project.offers" :key="myF">{{
              ...
              <div class="row">
                <div
                  class="d-xl-flex d-lg-flex d-md-flex d-sm-flex d-grid justify-content-center text-center"
                >
                  <div class="col-xl-5 col-lg-5 col-md-6 col-sm-6 col-12 pb-3">
              ...
              <div class="row justify-content-center">
                <button
                  type="button"
                  class="btn btn-danger rounded-3 delete-button px-5 my-2 w-25"
                  @click="deleteProject(project, project.id)"
                >
                  حذف
                </button>
              </div>
...
export default {
  setup() {
    ...
    const deleteProject = async (project, id) => {
      await axios
        .post(
          `https://test.m-aboelela.online/api/admin/projects/delete?project_id=${id}`,
          {
            project_id:id,
          },
          {
        ...
        .catch((rej) => {
          if (rej) {
            ...
            message.value = "فشل اجراء العملية";
