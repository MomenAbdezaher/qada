        ...
        <div class="text-end d-flex responsive-header" v-if="x.matches" style="direction:rtl;flex-wrap: wrap;">
          ...
          <div class="dropdown" :class="!auth ? 'd-none' : ''">
            ...
            <div v-motion-fade-visible
              style="width: 310px; height:360px ;transition: 0.5s ;background-color: #0c550b;padding-right: 10px;"
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-lg-baseline ">
            <li class="nav-item mx-lg-2">
              <router-link class="nav-link qada" to="/EngineeringOffices">ميدان<span>ي</span></router-link>
            </li>
            <li class="nav-item mx-lg-2">
            ...
            <li class="nav-item mx-lg-2">
              <router-link class="nav-link" router-link to="/EngineeringOffices/officePanelVue" v-if="auth">لوحة
                التحكم</router-link>
            </li>
...
<rect width="30" height="30" fill="white"/>
 ...
 <div v-if="notifications.officeProjectsRejected.length > 0" class="info">
  ...
  -->
                ...
                <!--officeProjectsUnder-vision projects
