      ...
      <div class="container-fluid ">
        ...
        <div class="text-end d-flex responsive-header" v-if="x.matches" style="direction:rtl;flex-wrap: wrap;">
          ...
          <div class="dropdown" v-if="auth">
            <button
              @click="new_backEndNotifications.seen_Notifications('https://test.m-aboelela.online/api/business/notifications_seen', 'https://test.m-aboelela.online/api/business/notifications')"
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-lg-baseline ">
            <li class="nav-item mx-lg-2">
              <router-link class="nav-link qada" to="/business">ميدان<span>ي</span></router-link>
            </li>
            <li class="nav-item mx-lg-2">
              <router-link :class="$route.fullPath == '/business' ? 'nav-link ra2esia' : 'nav-link'" to="/business">
                الرئيسية</router-link>
            </li>
            <li class="nav-item mx-lg-2">
              <router-link :class="$route.fullPath == '/business/aboutus' ? 'nav-link ra2esia' : 'nav-link'"
                to="/business/aboutus">من نحن؟</router-link>
            </li>
            <li class="nav-item mx-lg-2">
              <router-link :class="$route.fullPath == '/business/addProjectBussiness' ? 'nav-link ra2esia' : 'nav-link'"
                router-link to="/business/addProjectBussiness" v-if="auth">لوحة التحكم</router-link>
            </li>
            <li class="nav-item mx-lg-2">
              <router-link to="/business/faq"
                :class="$route.fullPath == '/business/faq' ? 'nav-link ra2esia' : 'nav-link'">الاسئلة
                المتكررة</router-link>
            </li>
            <li class="nav-item mx-lg-2">
              <router-link to="/business/termsandconditions" class="nav-link"
                :class="$route.fullPath == '/business/termsandconditions' ? 'nav-link ra2esia' : 'nav-link'">الشروط
                والاحكام</router-link>
            </li>
            <li class="nav-item mx-lg-2">
              <router-link to="/business/successPartners"
                :class="$route.fullPath == '/business/successPartners' ? 'nav-link ra2esia' : 'nav-link'">المكاتب الهندسية
              </router-link>
            </li>
            <li class="nav-item mx-lg-2">
              <router-link to="/business/contactus"
                :class="$route.fullPath == '/business/contactus' ? 'nav-link ra2esia' : 'nav-link'">إتصل بنا</router-link>
            </li>
            <button @click="router.push('/loginPanal')" :class="auth != '' ? 'd-none' : ''" type="button"
              class="btn  login mx-lg-4">تسجيل دخول</button>
            <button @click="router.push('/loginPanal')" :class="auth != '' ? 'd-none' : ''" type="button"
              class="btn   create">إنشاء حساب</button>
