        ...
        async getOneProject(api) {
            await axios.get(api, {
                ...
                .then((res) => {
                    ...
                    this.stages = this.projects.contract ? this.projects.contract.stages : [];
                    this.offers = this.projects.offers;
                    this.comments = this.projects.comments;
                    this.contract = this.projects.contract;
