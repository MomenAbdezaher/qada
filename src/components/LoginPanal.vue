    ...
    <div class="container-fluid row align-items-center" v-if="getData.data.length >= 0">
        <div class="row view align-items-center">
            <div class="col-lg-3 offset-lg-1 qdas ">
                <h1 class="mb-">منصة ميدان<span>ي</span></h1>
                <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <p>ساهمت منصة ميداني في تقليل عمر القضية بنسبة %79</p>
                        </div>

                        <div class="carousel-item">
                            <p>ساهمت منصة ميداني بإتاحة التقاضي إلكترونيًا لأكثر من 6 ملايين جلسة عن بعد، وإصدار 2 مليون حكم
                                قضائي إلكتروني</p>
                        </div>
                        <div class="carousel-item">
                            <p>ساهمت منصة ميداني في إصدار أكثر من مليون طلب تنفيذ، وأكثر من 1,6 مليون قرار تنفيذ إلكتروني
                            </p>
                        </div>
                        <div class="carousel-item">
           ...
           <span class="text-danger fs-1"> {{ collec.thename }}</span>  
                    ...
                    <div class="col-lg-3 card officeCard mx-lg-4 my-5">
                        <div class="card-body">
                            ...
                            <router-link to="/EngineeringOffices/login" class="btn btn-secondary my-2">تسجيل
                                دخول</router-link>
                            <div class="">
                                <router-link to="/EngineeringOffices/register" class="btn createBtn">إنشاء
                                    حساب</router-link>
                            </div>
                        </div>
                    </div>
